...
<style>
  body {
        ...
        background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.85)),
          url("Images/fondopags.jpg") no-repeat center center fixed;
  ...
  .poster {
    box-shadow: 0 0 15px #53FB18 !important;
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div>
                  <div class="dropdown" style="position: relative; disPlay: inline-block; padding-top: 5px; padding-left: 15px;">
                      ...
                      <div class="dropdown-content" style="color: white;">
                        ...
                        <a href="crime.html">Crimen</a>
                        <a href="suspense.html">Suspenso y Thriller</a>
                        <a href="action.html">Acción</a>
                      
                        <a href="documentary.html">Documental</a>
                        
                        <a href="drama.html">Drama</a>
                        <a href="war.html">Guerra y Política</a>
            ...
            <li>
  <button type="button" class="btn btn-light" onclick="redirectLogin()" onMouseOver="this.style.color='green'" onMouseOut="this.style.color='white'">ingresar</button>
</li>
  ...
  function redirectLogin() {
    ...
    window.location.href = 'login.php';
          ...
          <form id="searchForm" class="d-flex">
            ...
            <button style="background-color: #53FB18;" class="btn btn-danger" type="submit">BUSCAR</button>
          </form>
          <li>
  <button type="button" class="btn btn-danger" onclick="redirectIndex()"  onMouseOut="this.style.color='white'" style="border-color: red; text-transform: uppercase;">EXIT</button>
</li>
...
<script>
  function redirectIndex() {
    ...
    <marquee style="color: #53FB18;">BIENVENIDOS A <i>JDC-STREAMING </i>.com<sup>&reg;</sup></marquee>
    <label class="online" style="color: #53FB18;">
      ¡TRANSMITA LAS ULTIMAS PELICULAS!</label>
    ...
    <div class="maincontainer">
      ...
      <h2 style="color: #53FB18;">PELICULAS</h2>
      <hr>
      <div class="container">
...
<div class="container" id="Movies">
    ...
    <h2 style="color: #53FB18;">Web Series</h2>
    <hr>
  ...
  <!---third block -->
      ...
      <h2 style="text-align: center;color: #53FB18;">Anime</h2>
